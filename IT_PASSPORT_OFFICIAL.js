IT_PASSPORT_OFFICIAL = [
  ...
  {
      "Question": "PCや[サーバ]{server}、[ネットワーク]{network}などの[情報通信機器]{じょうほうつうしんきき}の[省エネ]{しょうえね}や[資源]{しげん}の[有効利用]{ゆうこうりよう}だけでなく、それらの[機器]{きき}を[利用]{りよう}することによって[社会]{しゃかい}の[省エネ]{しょうえね}を[推進]{すいしん}し、[環境]{かんきょう}を[保護]{ほご}していくという[考え方]{かんがえかた}はどれか。（[平成]{へいせい}22[年度]{ねんど}）",
      "Option": [
          "エコファーム",
          "環境アセスメント",
          "グリーンIT",
