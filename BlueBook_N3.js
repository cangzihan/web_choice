window.bluebook_n3 = [
    ...
    {
      "Question": "その[小説]{しょうせつ}はおもしろいので、[一気]{いっき}に（　　）じゃった。",
      "Option": ["読ん", "読み", "読む", "読んで"],
      "Analysis": "知识点79的注意部分\n読みます\n- ます形：よみます\n- て形：よんで\n- 字典形：よむ\n- ない形：よまない\n- た形：よんだ",
      "Unit": 8,
      "Correct Answer": 1
    ...
    {
      "Question": "[ヘリコプター]{へりこぷたー}が[東]{ひがし}の[空]{そら}へ[飛ん]{とん}で（　　）。",
      "Option": ["いった", "みた", "いる", "ある"],
      "Analysis": "直升机飞向东方天空。",
      "Unit": 9,
      "Correct Answer": 1
    ...
    {
      "Question": "[母]{はは}が[セーター]{せーたー}を[編んで]{あんで}（　　）。",
    ...
    {
      "Question": "[子ども]{こども}のいたずらで、[大声]{おおごえ}ででる（　　）のことではない。",
      "Option": ["ため", "はず", "よう", "ほど"],
      "Analysis": "知识点114\n这只是小孩子的恶作剧，不需要大声责骂。",
      "Unit": 12,
      "Correct Answer": 4
    ...
    {
      "Question": "[私]{わたし}は[音楽]{おんがく}（　　）、[ダンス]{だんす}（　　）が[好き]{すき}です。",
