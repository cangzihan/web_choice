window.bluebook_n3 = [
    ...
    {
      "Question": "[食事]{しょくじ}をしているあいだ（　　）、[ドア]{door}の[チャイム]{钟声}が[鳴っ]{なっ}た。",
      "Option": ["を", "と", "に", "は"],
      "Analysis": "知识点1",
      "Unit": 1,
      "Correct Answer": 3
    ...
    {
      "Question": "3[分]{ふん}（　　）[電車]{でんしゃ}が[ホーム]{home}に[入る]{いる}。",
    ...
    {
      "Question": "[暑い]{あつい}ですね。[ビール]{beer}か（　　）か[冷たい]{つめたい}[物]{もの}が[飲み]{のみ}たいですね。",
      "Option": ["どこ", "だれ", "なに", "どれ"],
      "Analysis": "知识点17",
      "Unit": 2,
      "Correct Answer": 3
    ...
    {
      "Question": "この[論文]{ろんぶん}は5つの[パート]{part}（　　）なっている。",
      "Option": ["しか", "まで", "でも", "から"],
      "Analysis": "知识点19的用法2",
      "Unit": 2,
      "Correct Answer": 4
    ...
    {
      "Question": "このあたりの[物件]{ぶっけん}は[高]{たか}（　　）、[普通]{ふつう}の[サラリーマン]{工薪族}では[買え]{かえ}そうもない。",
